<%-- 
    Document   : error-404
    Created on : 18/04/2014, 01:16:03 PM
    Author     : duran
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0061)http://www.spiralpixelthemes.co.uk/404-jigsaw-demo/index.html -->
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <![endif]-->
        <style type="text/css"></style><style type="text/css"></style><style type="text/css">/* Local ID — mndocdiojkckhpnhpeminpalidafeink */
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    <div id="whoops">
                        <img src="./img/404_dark.png" alt="" class="animated swing">
                    </div>
                </div>
                <div class="span2"></div>
                <div class="span8">
                    <table style="width: 700px ;text-align: left" >
                        <tr>
                            <td><h1> <% out.println("ContextPath();");%></h1></td>
                            <td><h1> <% out.println(request.getContextPath());%></h1></td> 
                        </tr>
                        <tr>
                            <td><h1> Type: </h1></td>
                            <td><h1> Status report </h1></td> 
                        </tr>
                        <tr>
                            <td><h1> Message: </h1> </td>
                        ...
                        <tr>
                            ...
                            <td><h1> The requested resource is not available. </h1></td>
                        </tr>
                    </table>
                </div>
            </div>
